  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-dark p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-card rounded-xl border border-border p-8 shadow-elegant">
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground text-sm">
              Não tem uma conta?{' '}
              <button className="text-info hover:text-info/80 transition-colors font-medium">
                Criar conta
              </button>
            </p>
          </div>
        ...
        {/* Demo Credentials */}
        <div className="mt-6 text-center">
          <p className="text-muted-foreground text-xs mb-2">Credenciais de demonstração:</p>
          <div className="flex flex-wrap justify-center gap-2 text-xs">
            <span className="bg-card/50 px-2 py-1 rounded border border-border">
