...
const initialCategories: Category[] = [
  {
    ...
    showInMainMenu: true,
    pageConfig: {
      bannerTitle: 'Programa de Aceleração HOF CIRCLE',
...
const initialCourses: Course[] = [
  ...
  // Trilha 1 - Pilar 1 (Always available)
  {
    ...
    description: 'O primeiro pilar do método HOF CIRCLE. Aprenda os fundamentos essenciais para construir uma base sólida.',
